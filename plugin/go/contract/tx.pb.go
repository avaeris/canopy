...
type MessageStake struct {
	...
	SenderAddress []byte `protobuf:"bytes,1,opt,name=sender_address,json=senderAddress,proto3" json:"senderAddress"` // @gotags: json:"senderAddress"
...
func (x *MessageStake) GetSenderAddress() []byte {
	if x != nil {
...
func (x *MessageUnstake) GetSenderAddress() []byte {
	if x != nil {
		return x.SenderAddress
	}
	return nil
...
func (x *MessageUnstake) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
const file_tx_proto_rawDesc = "" +
	...
	"\x06amount\x18\x03 \x01(\x04R\x06amount\"M\n" +
	"\fMessageStake\x12%\n" +
	"\x0esender_address\x18\x01 \x01(\fR\rsenderAddress\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x04R\x06amount\"O\n" +
	"\x0eMessageUnstake\x12%\n" +
	"\x0esender_address\x18\x01 \x01(\fR\rsenderAddress\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x04R\x06amount\"9\n" +
	"\x05Stake\x12\x18\n" +
...
var file_tx_proto_goTypes = []any{
	...
	(*MessageStake)(nil),   // 3: types.MessageStake
	(*MessageUnstake)(nil), // 4: types.MessageUnstake
	(*Stake)(nil),          // 5: types.Stake
